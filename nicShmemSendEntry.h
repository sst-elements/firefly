...
public:
    ...
    ShmemGetvSendEntry(int local_vNic, int streamNum, NicShmemSendCmdEvent *event,
                       Callback callback) :
...
public:
    ...
    ShmemFaddSendEntry(int local_vNic, int streamNum, NicShmemSendCmdEvent *event,
                       Callback callback) :
        ShmemRespSendEntry(local_vNic, streamNum, event), m_callback(callback) {
...
public:
    ...
    ShmemSwapSendEntry(int local_vNic, int streamNum, NicShmemSwapCmdEvent *event,
                       Callback callback) :
        ShmemRespSendEntry(local_vNic, streamNum, event), m_callback(callback) {
        m_shmemMove = new ShmemSendMoveValue(event->getValue());
...
public:
    ...
    ShmemCswapSendEntry(int local_vNic, int streamNum, NicShmemCswapCmdEvent *event,
                        Callback callback) :
        ShmemRespSendEntry(local_vNic, streamNum, event), m_callback(callback) {
...
public:
    ...
    ShmemGetbSendEntry(int local_vNic, int streamNum, NicShmemSendCmdEvent *event,
                       Callback callback) :
        ShmemRespSendEntry(local_vNic, streamNum, event), m_callback(callback) {
        m_hdr.op = ShmemMsgHdr::Get;
    }
