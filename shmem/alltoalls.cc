...
void ShmemAlltoalls::start(Vaddr dest, Vaddr source, int dst, int sst, size_t nelems, int elsize,
                           int PE_start,
    ...
    m_start_pe = m_peer = m_common.circular_iter_next(m_common.my_pe(), PE_start, logPE_stride,
                                                      PE_size);
